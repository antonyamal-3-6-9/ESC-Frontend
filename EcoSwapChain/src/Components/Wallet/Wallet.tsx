...
const Wallet: React.FC<WalletProps> = ({ 
  ...
  const convertToRs = (swapcoins: number): string => (swapcoins * 0.1).toFixed(2);
      ...
      <Slide in direction="up" timeout={500}>
        <AnimatedCard sx={{ maxWidth: 450, m: 2 }}>
          <Typography variant="h5" gutterBottom sx={{ 
            ...
            <img src="solana-logo.svg" alt="Solana" style={{ height: '1.2em' }} />
            Wallet
          </Typography>
          ...
          <Box sx={{ textAlign: 'center', py: 3 }}>
            ...
            <Typography variant="subtitle1" sx={{ color: 'secondary.main', mt: 1 }}>
